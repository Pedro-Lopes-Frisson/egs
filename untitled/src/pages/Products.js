...
export function Products() {
  ...
  useEffect(() => {
    console.log("ola")
    instance.get("http://localhost:8000/products/products", {
      headers: {
          ...
          <Container fluid className={"w-100"}>
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit} className={"mb-3"}>
              ...
              <Form.Group className="mb-3" controlId={"searchlimit"}>
                <Form.Select aria-label="Display Items" defaultChecked={searchLimit} onChange={handleSelect} >
